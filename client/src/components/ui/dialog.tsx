...
>(({ className, children, container, hideCloseButton, ...props }, ref) => {
  // Try to find the mobile container for phone frame containment
  const portalContainer = container ?? (typeof document !== 'undefined' ? document.getElementById('mobile-container') : null);
  
  return (
    <DialogPortal container={portalContainer}>
      <DialogOverlay className={portalContainer ? "absolute" : "fixed"} />
